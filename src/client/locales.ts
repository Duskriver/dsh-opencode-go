...
export const en = {
  ...
  modelsStale: 'Refresh failed. Showing the last fetched models, also used by conversation pickers. Their current availability could not be confirmed.',
  ...
  configurationMissingHint: 'The gateway lists this model, but its OpenCode Go configuration is missing. It cannot be enabled.',
...
export const zh: typeof en = {
  ...
  modelsStale: '刷新失败，正在显示上次获取的模型；会话选择器也使用这份缓存，当前可用性尚未确认。',
  ...
  configurationMissingHint: '网关已列出此模型，但缺少对应的 OpenCode Go 配置，暂不可开启。',
