...
export const en = {
  ...
  limitsHint: 'Override the context window or max output for a model. Leave a field blank to use the catalog value.',
  ...
  limitsAdvertised: 'Catalog: {context} / {output}',
...
export const zh: typeof en = {
  ...
  limitsLabel: '模型容量',
  limitsHint: '为模型覆盖上下文窗口或最大输出。留空的字段会使用目录公布的容量。',
  ...
  limitsContext: '上下文窗口',
  limitsOutput: '最大输出',
  limitsAdvertised: '目录：{context} / {output}',
